...
<?php
    while($result =  mysqli_fetch_assoc($data))
    {
        echo "<tr>
               ...
               <td> <a href = 'update.php?name=$result[name]'> <button class = 'edit'> Edit </button> </a> 
...
if(mysqli_num_rows($result1)>0){
    ...
    if($page>1){
        echo'<li><a href = "read.php?page='.($page-1).'"> Previous </a></li>';
    }
    ...
    for($i=1; $i<$total_page; $i++){
       ...
       echo '<li class = "'.$active.'"><a href ="read.php?page='.$i.'">'.$i.'</a></li>';
   }
   if($total_page> $page){
    echo'<li><a href = "read.php?page='.($page+1).'"> Next </a></li>';
   }
